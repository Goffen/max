...
public class UtbildninginstansDecoder
{
    ...
    private final UtbildninginstansDecoder parentMessage = this;
    ...
    public UtbildninginstansDecoder wrap(
    ...
    public byte kod(final int index)
    {
        if (index < 0 || index >= 12)
        {
    ...
    public int getKod(final byte[] dst, final int dstOffset)
    {
        final int length = 12;
    ...
    public String kod()
    {
        ...
        buffer.getBytes(this.offset + 4, dst, 0, 12);

        int end = 0;
        for (; end < 12 && dst[end] != 0; ++end);

        return new String(dst, 0, end, java.nio.charset.StandardCharsets.ISO_8859_1);
    }
    ...
    public static int benamningSvSinceVersion()
    {
        return 0;
    }
    ...
    public int benamningSvLength()
    {
        final int limit = parentMessage.limit();
        return (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    }

    public int getBenamningSv(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
    ...
    public int getBenamningSv(final byte[] dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public void wrapBenamningSv(final DirectBuffer wrapBuffer)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public static int benamningEnSinceVersion()
    {
        return 0;
    }
    ...
    public int benamningEnLength()
    {
        final int limit = parentMessage.limit();
        return (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    }

    public int getBenamningEn(final MutableDirectBuffer dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public int getBenamningEn(final byte[] dst, final int dstOffset, final int length)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public void wrapBenamningEn(final DirectBuffer wrapBuffer)
    {
        final int headerLength = 4;
        final int limit = parentMessage.limit();
        final int dataLength = (int)(buffer.getInt(limit, java.nio.ByteOrder.LITTLE_ENDIAN) & 0xFFFF_FFFFL);
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[Utbildninginstans](sbeTemplateId=");
        ...
        builder.append(version());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='kod', referencedName='null', description='null', id=2, version=0, deprecated=0, encodedLength=12, offset=4, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        //Token{signal=ENCODING, name='string12', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=12, offset=4, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='ISO-8859-1', epoch='null', timeUnit=null, semanticType='null'}}
        builder.append("kod=");
        for (int i = 0; i < kodLength() && kod(i) > 0; i++)
        {
            builder.append((char)kod(i));
        }
        builder.append('|');
        //Token{signal=BEGIN_VAR_DATA, name='benamningSv', referencedName='null', description='null', id=3, version=0, deprecated=0, encodedLength=0, offset=16, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        builder.append("benamningSv=");
        builder.append('\'' + benamningSv() + '\'');
        builder.append('|');
        //Token{signal=BEGIN_VAR_DATA, name='benamningEn', referencedName='null', description='null', id=4, version=0, deprecated=0, encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        builder.append("benamningEn=");
        builder.append('\'' + benamningEn() + '\'');
